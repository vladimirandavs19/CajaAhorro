...
namespace CajaAhorro.Web.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(ICompanyRepository companyRepository, IUserHelper userHelper)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var company = await companyRepository.GetByIdAsync(id.Value);
            if (company == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create(Company company)
        {
            ...
            {
                //TODO: Pending to change to: User.Identity.Email
        ...
        public async Task<IActionResult> Edit(Company company)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!await companyRepository.ExistAsync(company.Id))
                    {
                        return NotFound();
                    }
                    else
